 ...
 */
export declare function merge<T extends IObject[]>(...objects: T): TMerged<T[number]>;
export declare namespace merge {
    var options: MergeOptions;
    var withOptions: <T extends IObject[]>(options: Partial<MergeOptions>, ...objects: T) => TMerged<T[number]>;
}
